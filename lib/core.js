(function() {
  ...
  this.split_primary_record_key = function(me, prk) {
    var match;
  ...
  this.split_secondary_record_key = function(me, srk) {
    var match;
