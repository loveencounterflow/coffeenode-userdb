...
(function() {
  ...
  this.new_db = function() {
    ...
    */
    ...
    substrate.select(collection_idx, function(error, response) {
      if (error != null) {
        throw error;
      }
    });
  ...
  this._build_indexes = function(me, entry, pkn_and_skns, handler) {
    ...
    */
    ...
    me['%self'].hmset(prk, record, function(error, response) {
  ...
  this.remove = function(me, pattern, handler) {
    ...
    this.get_keys(me, pattern, function(error, keys) {
      if (error != null) {
        return handler(error);
      }
  ...
  this.walk_keys = function(me, pattern, handler) {
    ...
    */
    ...
    var _this = this;
    return me['%self'].keys(pattern, function(error, response) {
      var key, _i, _len;
      if (error != null) {
        return handler(error);
      }
  ...
  this.entry_from_primary_record_key = function(me, prk, fallback, handler) {
    ...
    this.record_from_prk(me, prk, function(error, value) {
      if (error != null) {
        if (fallback === void 0) {
          return handler(error);
        }
  ...
  this.record_from_prk = function(me, prk, fallback, handler) {
    ...
    debug('©4r', rpr(prk));
    me['%self'].type(prk, function(error, type) {
      if (error != null) {
        return handler(error);
      }
      switch (type) {
