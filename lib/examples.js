...
(function() {
  ...
  this.new_user_collection = function(me, handler) {
    ...
    return USERDB.new_collection(me, description, function(error, result) {
      if (error != null) {
  ...
  this.safe_new_user_collection = function(db, handler) {
    var _this = this;
    return USERDB.remove_collection(db, function(error, result) {
      if (error != null) {
  ...
  this.populate = function() {
    var _this = this;
    return this.safe_new_user_collection(db, function(error) {
      if (error != null) {
        throw error;
      }
  ...
  this.authenticate_users = function(db) {
    ...
    for (_i = 0, _len = uid_hints_and_passwords.length; _i < _len; _i++) {
      ...
      _results.push((function(uid_hint, password, probe_user, probe_password) {
      ...
      })(uid_hint, password, probe_user, probe_password));
    }
    return _results;
  };
